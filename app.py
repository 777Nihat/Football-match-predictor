...
EXCLUDED_TEAMS = {
    "Madrid", "Yerevan", "Armenia", "Artsakh", "Barcelona", 
    "Catalonia", "Basque Country", "Unknown", "Test", 
    "Corsica", "Silesia", "Abkhazia", "South Ossetia", "Transnistria","Aymara","Barawa","Felvidék","German DR"
}
